package com.example.dam.aadlistview.data;

/*
A los objetos de estas clases se les llama: plain old java object, también se les llama clase pojo:
que tiene getters, setters, un constructor vacio y opcionalmente mas constructores.
*/
